...
const Roomd = () => {
  ...
  const submitform = async (e) => {
    ...
    if(selectoption==="" || inputvalue===""){
      ...
      await axios.post("https://guest-house-booking-website.onrender.com/rooms/enter", { "roomnumber": selectoption, "options": inputvalue }, {
        headers: {
  ...
  const submitaform = async (e) => {
    ...
    if(needadmin==="" || newpass===""){
      alert("Please fill all the details!")
        ...
        await axios.post("https://guest-house-booking-website.onrender.com/users/newadmin", {
            "username": needadmin,
            "password": newpass
          }, {
            headers: {
